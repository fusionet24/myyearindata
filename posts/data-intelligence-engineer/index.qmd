...
At **SQLBITS 2025**, the contrast between my session and Simon's could not have been more stark. I presented ["Danger In Dialogue: The Security Risks in LLMs"](), where I focused on how people are not taking the security part of this new technology seriously enough. Simon, on the other hand, gave a talk all about embracing AI. On the surface, our messages seem opposed. But we both agree on the core point: you have to get ahead of the game. Because other people already are.
